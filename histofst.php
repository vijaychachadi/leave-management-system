...
if(isset($_COOKIE[$cookie_name])) {
	require 'db.php';
$check="SELECT s.App_id,l.fdate,l.tdate,l.Description,s.remarks,s.Approval FROM leaves l, status1 s WHERE l.App_id = s.App_id AND l.usn='$usn' order by S.App_id DESC";
...
<body background="jce.jpg">
	...
	<br>
	<h4 style="text-align: center;" >LEAVE APPLICATION HISTORY OF USN : '.$usn.' </h4>
	<br>
	...
	<tr >
		 ...
		 <th><h4> FROM </h4></th>
		 <th><h4> TO </h4></th>
		 <th><h4> Description of STUDENT </h4></th>
